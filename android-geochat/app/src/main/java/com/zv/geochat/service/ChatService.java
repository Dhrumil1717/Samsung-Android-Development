...
public class ChatService extends Service {
    ...
    public  static final int CONNECT_ERROR_91 = 91;
    public static int SEND_RANDOM_ID;
    ...
    private void handleData(Bundle data) {
        ...
        }else if (command == CONNECT_ERROR_91 ){
            String testMessage ="CONNECT_ERROR_91";
            notificationDecorator.displaySimpleNotification("New message...: ", testMessage);
        }
        else if (command == SEND_RANDOM_ID) {
            String messageText = (String) data.get(String.valueOf(KEY_MESSAGE_TEXT));
            notificationDecorator.displaySimpleNotification("Chat Received", messageText);
        }
        else {
